...
def get_sleep_time():
    ...
    # 第二天7点时间戳
    tomorrow_run_time = int(time.mktime(time.strptime(str(tomorrow), '%Y-%m-%d'))) + random.randint(3600*12, 3600*20)
...
if __name__ == "__main__":
    ...
    while 1:
        while fail_num > 0:
            try:
                # 执行一键修改步数
                XiaomiSport('13399379495','ycy12569800',10560).one_click_change_step()
                break
